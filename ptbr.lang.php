...
return [
    ...
    "view_more"             => "Ver mais",
    "sort_by"               => "CATEGORIZAR POR",
    "follow"				=> "Seguir",
    "unfollow"				=> "Deixar de seguir",
    // Channel Types
    "channeltype_member"    => "Membro",
    "channeltype_animator"  => "Animador",
    "channeltype_comedian"  => "Comedista",
    "channeltype_director"  => "Diretor",
    "channeltype_gamer"     => "Gamer",
    "channeltype_guru"      => "Guru",
    "channeltype_reporter"  => "Reporter",
    "channeltype_reviewer"  => "Reviewer",
    "channeltype_musician"  => "Músico",
    "channeltype_member2"    => "Membros",
    "channeltype_animator2"  => "Animadores",
    "channeltype_comedian2"  => "Comedistas",
    "channeltype_director2"  => "Diretores",
    "channeltype_gamer2"     => "Gamers",
    "channeltype_guru2"      => "Gurus",
    "channeltype_reporter2"  => "Reporters",
    "channeltype_reviewer2"  => "Reviewers",
    "channeltype_musician2"  => "Músicos",
    // Video Categories
    "category_animation"    => "Animação e Filmes",
    "category_autos"        => "Autos e Veículos",
    "category_beauty"       => "Beleza e Estilo",
    "category_comedy"       => "Comédia",
    "category_education"    => "Educação",
    "category_entertainment"=> "Entreterimento",
    "category_gaming"       => "Jogos",
    "category_music"        => "Música",
    "category_news"         => "Notícia",
    "category_nonprofits"   => "Sem Fins Lucrativos e Ativismo",
    "category_pets"         => "Pets e Animais",
    "category_politics"     => "Política",
    "category_reviews"      => "Reviews",
    "category_science"      => "Ciência e Tecnologia",
    "category_sports"       => "Esportes",
    "category_travel"       => "Viagens e Eventos",
    "category_tutorials"    => "Tutoriais e Como Fazer",
    "category_vlogs"        => "Vlogs",
    // Navigation
    "nav_home"              => "Início",
    "nav_follow"            => "Meus Seguidores",
    "nav_trending_videos"   => "Vídeos em Alta",
    "nav_featured"          => "Vídeos em Destaque",
    "nav_videos"            => "Todos os Vídeos",
    "nav_trending_channels" => "Canais em Alta",
    "nav_all_channels"      => "Todos os Canais",
    "nav_blogs"             => "Blogs dos Canais",
    "nav_groups"            => "Grupois",
    "nav_watch_history"     => "Histórico de Exibição",
    "nav_statistics"        => "Estatísticas",
    "nav_settings"          => "Configurações",
    "nav_community"			=> "Comunidade",
    "nav_about"				=> "Sobre você",
    "nav_signin"            => "Entrar",
    "nav_signup"            => "Registrar",
    "nav_search_text"       => "Procurar",
    "nav_search_text_mobile"=> "Coloque um termo de pesquisa...",
    "nav_upload_text"       => "Fazer Upload",
    "nav_cannot_upload"     => "Você não pode fazer upload!",
    "nav_notification_text" => "Notificações",
    "nav_drop_channel"      => "Meu Canal",
    "nav_drop_dashboard"    => "Painel de Controle",
    "nav_drop_manager"      => "Gerênciador de Conteúdo",
    "nav_drop_add_channel"  => "Adicionar Canal",
    "nav_drop_signout"      => "Sair",
    "nav_drop_sure"			=> "Tem certeza que quer sair??",
    "nav_footer_about"      => "Sobre nós",
    "nav_footer_help"       => "Ajuda",
    "nav_footer_guidelines" => "Diretrizes",
    "nav_footer_terms"      => "Termos de Uso",
    "nav_footer_privacy"    => "Política de Privacidade",
    "nav_footer_copyright"  => "Direitos Autorais",
    "nav_mark_as_read"      => "marcar como lido",
    "nav_notif_commented"   => "Comentado",
    "nav_notif_replied"     => "Respondido",
    // Modals (Pop-Ups)
    "modal_sign_signin"         => "Entrar",
    "modal_sign_signin_text"    => "Entrar em uma conta existente.",
    "modal_sign_signin_email"   => "E-Mail",
    "modal_sign_signin_password"=> "Senha",
    "modal_sign_signin_button"  => "ENTRAR",
    "modal_sign_signin_new"     => "Novo ao VidLii?",
    "modal_sign_signin_forgot"  => "Esqueceu a senha?",
    "modal_sign_signin_forgot_!"=> "Resetar-a",
    "modal_sign_signup"         => "Registrar",
    "modal_sign_signup_text"    => "Criar uma nova conta no VidLii.",
    "modal_sign_signup_name"    => "Apelido",
    "modal_sign_signup_name_no"	=> "Apelidos não podem ter: (' \ / < >)",
    "modal_sign_signup_email"   => "E-Mail",
    "modal_sign_signup_pass1"   => "Senha",
    "modal_sign_signup_pass2"   => "Repita a senha",
    "modal_sign_signup_contin"  => "CONTINUAR",
    "modal_sign_signup_already" => "já tem uma conta no VidLii?",
    "modal_sign_signup_birth"   => "Seu Aniversário",
    "modal_sign_signup_who"     => "Quem é você?",
    "modal_sign_signup_country" => "Qual é o seu país?",
    "modal_sign_signup_male"    => "Masculino",
    "modal_sign_signup_female"  => "Feminino",
    "modal_sign_signup_other"   => "Outro(a)",
    "modal_sign_signup_button"  => "REGISTRAR",
    "modal_sign_signup_agree"   => "Ao clicar em \"Registrar\", você concorda com os nossos <a href='/terms'>Termos de Serviço</a>!",
    "modal_add_video_to_group"          => "Adicionar vídeo ao grupo",
    "modal_add_video_to_group_enter"    => "Coloque o título",
    "modal_add_video_to_group_submit"   => "",
    "modal_avatar_title"		=> "Enviar Avatar do Canal",
    "modal_avatar_filters"		=> "Adicionar Filtros",
    "modal_avatar_delete"		=> "Apagar Avatar do Canal",
    "modal_avatar_upload"		=> "Envie uma imagem",
    "modal_avatar_max"			=> "(máx. 2MB | Recomendado: 500x500)",
    "modal_avatar_uploading"	=> "Enviando...",
    "modal_banner_title"        => "Enviar arte do canal",
    "modal_banner_delete"       => "Apagar arte do canal",
    "modal_banner_max"          => "(máx. 2MB | Recomendado: 1700x275)",
    // Homepage
    "home_being_watched"    => "Vídeos Sendo Assistidos Agora",
    "home_trending_videos"  => "Vídeos em Alta",
    "home_recommended"      => "Vídeos Recomendados",
    "home_trending_channels"=> "Canais em Alta",
    "home_featured_videos"  => "Vídeos em Destaque",
    // Trending Videos
    "trendingvideos_title"  => "Em alta: [where] (Clique para Reproduzir)",
    "trendingvideos_title2" => "Em alta no(a) [where] (Clique para Reproduzir)",
    // Featured Videos
    "featuredvideos_title"  => "Vídeos em Destaque",
    "featuredvideos_text"   => "Vídeos em Destaque são vídeos which our Staff thinks are high quality and deserve to be seen. We try to feature different types of videos so no certain type of content is favored. You can recommend us videos to feature under the \"Share\" button on the video page.",
